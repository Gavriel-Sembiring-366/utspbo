...
public class LogInController {
    ...
    @FXML private ImageView imageViewKasir;
    ...
    @FXML
    private void swapLogin() throws IOException {
        // String opt = textTitle.getText();
        // if(opt.equals("Log In")){
        //     App.setRoot("login_admin");
        // }
        // else if(opt.equals("Log In As Admin")){
        //     App.setRoot("login");
        // }
    }
