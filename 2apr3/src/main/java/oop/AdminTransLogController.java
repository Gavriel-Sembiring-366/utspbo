...
public class AdminTransLogController {
    ...
    @FXML private TextField textFieldSearchItem;
    ...
    @FXML private Label labelSelectItem;
    ...
    private void reloadTable(String selectedItem){
        List<TransactionLog> transLogs = TransactionLogDB.getFilteredTransactionLogs(selectedItem);
    ...
    @FXML 
    private void actionFindItem() throws IOException, SQLException{
        tableViewItem.getItems().clear();
        String selectedItem = textFieldSearchItem.getText();
        reloadTable(selectedItem);
    }
