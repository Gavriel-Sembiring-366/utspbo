...
public class Purchase {
    ...
    // public Purchase(){
        ...
        public Purchase(int no, String kode, String nama, int harga, int jumlah, int total){
            this.table_no = no;
        ...
        public int getTable_harga() {return table_harga;}
        public int getTable_jumlah() {return table_jumlah;}
        public int getTable_total() {return table_total;}
